...
- Use the reference image below to create a stopwatch:
  ...
  - it should have a `1vmin`  round border with `#000` color
...
In addmake a full circle (change animation duration)
- it will take only `10minition to the basic functionality create a BEM modifier called `speed-up` for your stopwatch block:
- it will take only `10s` for the seconds hand to ` for the minutes hand to make a full circle (change animation duration)
...
- [DEMO LINK](https://<Tarasov123555>.github.io/layout_stop-watch/)
