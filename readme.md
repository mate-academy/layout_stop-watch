...
- Use the reference image below to create a stopwatch:
  - place it in the center of the page (vertically and horizontally) - done
  - stopwatch must have a size of `80vmin` x `80vmin` - done
  - it should have a `1vmin` dotted round border with `#000` color -done
  - minutes hand should have a length of `20vmin` and `3vmin` width with blue (`#0700ff`) color - done
  - seconds hand should have a length of `38vmin` and `1.5vmin` width with green (`#2c8000`) color - done
  - the center of the stopwatch should be a circle with a diameter of `5vmin` and orange (`#f6a603`) color -done
- The starting position of the hands should be at the top. - done
...
- [DEMO LINK](https://anastat1on.github.io/layout_stop-watch/)
