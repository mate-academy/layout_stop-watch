...
❗️ Replace `Svitlana-Vitryk` with your Github username and copy the links to `Pull Request` description:
- [DEMO LINK](https://Svitlana-Vitryk.github.io/layout_stop-watch/)
